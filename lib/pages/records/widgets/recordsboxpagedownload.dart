...
class RecordBoxDScreen extends StatefulWidget {
  final AppState appState;
  final SelectedRecordState recordState;

  const RecordBoxDScreen({Key key, this.appState, this.recordState})
      : super(key: key);
  @override
  _RecordBoxDScreenState createState() => _RecordBoxDScreenState();
}

class _RecordBoxDScreenState extends State<RecordBoxDScreen> {
  @override
  Widget build(BuildContext context) {
    final message =
        // ignore: lines_longer_than_80_chars
        'https://www.cvk.teczo.co/records/${widget.recordState.selectedrecord}';
  ...
  Future<void> downloadImage() async {
    final qrValidationResult = QrValidator.validate(
      data: 'https://www.cvk.teczo.co/records/1',
      version: QrVersions.auto,
    ...
    final downloadqrCode = qrValidationResult.qrCode;
